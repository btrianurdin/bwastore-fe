import { DataDetailTypes } from '../../../services/data-types';
...
export default function TopUpItem({ type, data }: Props): JSX.Element {
  if (type === 'desktop') {
    return (
  ...
  return (
    <div className="row align-items-center">
      <div className="col-md-12 col-4">
        <img src={`${process.env.NEXT_PUBLIC_IMAGE_URL}/${data.thumbnail}`} width="280" height="380" className="img-fluid" alt="" />
      </div>
